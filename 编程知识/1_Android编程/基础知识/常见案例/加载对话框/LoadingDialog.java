package com.example.llj.mywidget;
...
import com.example.llj.feilala_user.R;
...
public class LoadingDialog extends Dialog {
    ...
    public LoadingDialog(@NonNull Context context,String message,int imageId,boolean cancelable) {
        this(context,R.style.LoadingDialog,message,imageId,cancelable);
    }
    ...
    private void initView() {
        ...
        int screenWidth = windowManager.getDefaultDisplay().getWidth();//获取屏幕框
        ...
        setCancelable(mCancelable);     //是否能按返回键取消
