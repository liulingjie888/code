...
<form action="${pageContext.request.contextPath}/update?type=manager_pawd" method="post" onsubmit="return isOk()">
    <table align="center" border="0" cellpadding="13" cellspacing="0">
        ...
        <tr>
            ...
            <td align="center"><input type="button" onclick="location.href='${pageContext.request.contextPath}/JSP/manager/managerHome.jsp';" value="返回"/></td>
        </tr>
    </table>
</form>
</body>
