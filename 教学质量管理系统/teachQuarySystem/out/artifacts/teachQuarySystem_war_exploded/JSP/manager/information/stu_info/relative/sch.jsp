...
<body>
<h2 align="center">学生课程</h2>
<br>
<table align="center" >
    <tr>
        <td width="240" ><input type="search" id="searchText" placeholder="输入课程或学生学号"/></td>
...
<script>
    window.onload=function() {
        var url=requestUrl+"?page=<%=session.getAttribute("sch_page")==null?1:session.getAttribute("sch_page")%>&searchText="+searchInput.value+"&searchCode="+searchCode.value;
        xmlhttp.open("GET",url,true);
        xmlhttp.send(null);
    }
    var requestUrl="${pageContext.request.contextPath}/JSP/manager/information/stu_info/relative/sch_show.jsp";
