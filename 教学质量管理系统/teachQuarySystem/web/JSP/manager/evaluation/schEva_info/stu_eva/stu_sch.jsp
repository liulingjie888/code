...
<table align="center" id="table_navigation">
    <tr>
        <td width="130"><a href="#" onclick="location.href='${pageContext.request.contextPath}/JSP/manager/evaluation/schEva_info/schEva_info.jsp';">学生测评管理</a></td>
        <td width="100"></td>
        <td width="150"></td>
...
<table align="center">
    <tr>
        <td ><input type="radio" id="1" name="standard" onclick="good()"/></td><td width="150">优秀课程:</td>
        <td><input type="radio" id="2" name="standard" onclick="nogood() "  checked/></td><td width="150">合格课程:</td>
        <td><input type="radio" id="3" name="standard" onclick="bad()" /></td><td width="170">不合格课程:</td>
...
<script>
    ...
    var requestUrl="${pageContext.request.contextPath}/JSP/manager/evaluation/schEva_info/stu_eva/show.jsp";
    var standard=2;
    ...
    window.onload=function() {
        var url=requestUrl+"?page=<%=session.getAttribute("stu_sch_page")==null?1:session.getAttribute("stu_sch_page")%>&type="+standard+"&code="+code.value;
