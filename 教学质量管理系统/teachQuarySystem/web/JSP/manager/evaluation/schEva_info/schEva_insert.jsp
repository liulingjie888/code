...
<body>
<h2 align="center">添加课程测评</h2><br>
<form action="${pageContext.request.contextPath}/insert?type=schEva_info" method="post" target="_self" onsubmit="return isOk()">
    <table align="center" cellpadding="8" cellspacing="0">
        <tr>
            <td align="right">课程ID:</td>
            <td><input type="text" id="sch" name="sch_id" onkeyup="sch_check()" list="schedule" required /><span id="sch_hint"></span></td>
        ...
        <tr>
            ...
            <td><input type="text" id="stu" onkeyup="stu_check()" list="students" name="stu_num" required/><span id="stu_hint"></span></td>
