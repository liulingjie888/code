...
<%@ page import="com.jie.object.StuTea" %><%--
...
<%
    ...
    String sql="select * from stu_tea where tea_id like '%"+searchText+"%' or stu_num like '%"+searchText+"%'";
    ...
    List<StuTea> list=(ArrayList<StuTea>)db.query(sql+" limit ?,?",new BeanListHandler(StuTea.class), DBUtil.row*(Page-1),DBUtil.row);
    int rest=DBUtil.row;
%>
<p align="center">数量：<%=(int)num%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;页：<%=Page%>&nbsp;/&nbsp;<%=maxPage%></p>
<form id="myform" method="post" action="${pageContext.request.contextPath}/delete?type=stu_tea" onsubmit="return isDelete()" target="_self">
    <table align="center" border="1" cellpadding="2" cellspacing="0">
        <tr id="navigation">
            <td width="150">ID</td><td width="150">教师ID</td><td width="150">学生学号</td>
