...
<body>
<h2 align="center">教师信息查询</h2><br>
<table align="center">
    <tr>
        <td width="30"></td>
        <td width="240"><input type="search" id="searchText" placeholder="输入姓名、ID"/></td>
...
<script>
    window.onload=function() {
        var url=requestUrl+"?page=<%=session.getAttribute("tea_info_page_student")==null?1:session.getAttribute("tea_info_page_student")%>&searchText="+searchInput.value+"&searchCode="+searchCode.value;
        xmlhttp.open("GET",url,true);
        xmlhttp.send(null);
    }
    var requestUrl="${pageContext.request.contextPath}/JSP/student/tea_info/tea_info_show.jsp";
